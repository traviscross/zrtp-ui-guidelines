...
e.g., in the case of a TLS certificate authentication failure:
    ...
    Your connection with the server is NOT secure.  The server is
    being impersonated by an untrusted party.  Information regarding
    who is calling whom may be intercepted, and calls may not be
    confidential.
